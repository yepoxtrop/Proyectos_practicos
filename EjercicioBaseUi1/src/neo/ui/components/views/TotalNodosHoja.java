...
public class TotalNodosHoja extends JPanel {
	 ...
	 * Create the panel.
	 */
	public TotalNodosHoja(Arbol arbol, JFrame ventana) {
		...
		JLabel lblNewLabel = new JLabel("TOTAL NODOS HOJA");
	...
	public String valor() {
        return Integer.toString(arbol.cantidadNodosHoja());
    }
