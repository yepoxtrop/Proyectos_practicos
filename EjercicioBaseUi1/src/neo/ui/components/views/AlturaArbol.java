...
public class AlturaArbol extends JPanel {
	 ...
	 * Create the panel.
	 */
	public AlturaArbol(Arbol arbol, JFrame ventana) {
		...
		JLabel lblNewLabel = new JLabel("ALTURA DEL ÁRBOL");
	...
	public String valor() {
        return Integer.toString(arbol.retornarAltura());
    }
