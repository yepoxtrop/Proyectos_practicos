...
public class ValorMenor extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ValorMenor(HomeroSimpson homeroSimpson, JFrame ventana) {
		...
		JLabel lblNewLabel = new JLabel("VALOR MAYOR DEL ÁRBOL");
	...
	public String valor() {
		if (!(homeroSimpson.getCantidad() > 0)) {
    		return "No hay nodos";
    	}else {
    		return Integer.toString(homeroSimpson.mayorValor());
    	} 
    ...
    public void actualizarValor() {
    	...
    	if (!(homeroSimpson.getCantidad() > 0)) {
    		...
    		lblNewLabel_1.setText(val==1?val+" dia":val +"dias");
    	}
