...
public class ImprimirPreOrden extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ImprimirPreOrden(HomeroSimpson homeroSimpson, JFrame ventana) {
		...
		JLabel lblNewLabel = new JLabel("IMRPIMIR EN PRE ORNDEN");
	...
	public int[][] modificarFilas(){
		...
		Resultados peticion = homeroSimpson.imprimirPreOrden();
