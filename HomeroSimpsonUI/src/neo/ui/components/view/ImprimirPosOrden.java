...
public class ImprimirPosOrden extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ImprimirPosOrden(HomeroSimpson homeroSimpson, JFrame ventana) {
		...
		JLabel lblNewLabel = new JLabel("IMRPIMIR EN POS ORNDEN");
